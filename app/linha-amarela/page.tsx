...
export const metadata = {
  ...
  description: "Locação de retroescavadeiras, escavadeiras e equipamentos de terraplanagem. Máquinas pesadas para movimentação de terra.",
};
...
export default async function LinhaAmarelaPage() {
  ...
  try {
    ...
    const { data: rows, error } = await supabase
      ...
      .eq("categoria", "linha-amarela")
      .order("ordem", { ascending: true });

    if (error) {
      console.error("Supabase equipamentos linha-amarela:", error.message);
    } else {
    ...
    console.error("Linha amarela fetch error:", e);
  }
      ...
      <section className="pt-24 pb-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-muted mb-8 sm:mb-10 max-w-2xl">
            Equipamentos de terraplanagem e movimentação de terra para obras de infraestrutura. Retroescavadeiras, escavadeiras e máquinas pesadas.
          </p>
          {equipamentos.length > 0 ? (
            ...
            <div className="bg-card-bg border border-theme-border rounded-xl p-8 sm:p-12 text-center">
              <p className="text-text-muted">
                Nenhum equipamento com imagem encontrado para Linha Amarela. Verifique a categoria &quot;linha-amarela&quot; e o preenchimento de <strong>imagem_url</strong> na tabela equipamentos do Supabase.
              </p>
              <Link
                href="/equipamentos"
